...
void Game::EndScreen(){
  ...
  score_text.setString("Your score: " + std::to_string(game_score_));
...
int Game::GetPlayerScore() { return current_level_.GetPlayerTank().GetScore(); }
...
void Game::ResetPlayer() {
  current_level_.GetPlayerTank().ResetScore();
